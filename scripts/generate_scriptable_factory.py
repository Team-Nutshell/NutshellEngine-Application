...
output = "// This file is automatically generated by generate_scriptable_factory.py from CMake\n\n"
output += "#pragma once\n"
output += "#include \"../Core/Common/ecs/components/ntshengn_ecs_scriptable.h\"\n"
output += "#include \"../Core/scripting/ntshengn_script_keeper.h\"\n"
...
output += "\t\tScriptable createScriptable(ScriptKeeper* scriptKeeper, const std::string& scriptName) {\n"
if (len(scriptNames) == 0):
	output += "\t\t\tNTSHENGN_UNUSED(scriptKeeper);\n"
...
for i, scriptName in enumerate(scriptNames):
	...
	if (i != 0):
		output += "else "
	output += "if (scriptName == \"" + scriptName + "\") { scriptable.script = scriptKeeper->createScript<" + scriptName + ">(); }\n"
output += "\n\t\t\treturn scriptable;\n"
output += "\t\t}"
output += "\n\n\t}"
output += "\n\n}"
